...
export default function ContactForm() {
  return (
    <Form className="bg-primary w-full p-5 py-12 lg:py-16 rounded-md">
            <div className="flex justify-center items-center flex-col pb-5">
              ...
              <div className="flex flex-col gap-3 w-[100%]">
                <div className="flex justify-around items-center gap-3 md:gap-3 flex-col lg:flex-row w-[90%] m-auto">
                  <Input
                    type="text"
